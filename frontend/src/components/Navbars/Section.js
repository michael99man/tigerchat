                ...
                <Container>
                    ...
                    />*/}
                        ...
                        <i className="ni ni-settings-gear-65" />
                                ...
                                <h3>
                                    <div className="sub">HOW IT WORKS</div>
                                </h3>
                                <p className="lead">
                                    Tigerchat allows you to meet other Princeton students under the condition of
                                    anonymity on a text-based platform.
                                </p>
                ...
                <Container>
                    <Row className="justify-content-center text-center mb-lg">
                        <Col lg="8">
                            ...
                            <p className="authors">Created by ...</p>
                        </Col>
                    </Row>
                    {/* SVG separator */}
                                    ...
                                    <div className="d-flex px-3">
                                        ...
                                        <div className="pl-4">
                                            ...
                                            <p className="faq">
                                                ...
                                                to the development team and their fellow users. If you decide to reveal your
                                                identity, then
